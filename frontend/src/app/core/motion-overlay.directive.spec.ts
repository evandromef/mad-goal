...
describe('MotionOverlayDirective', () => {
  it('torna o overlay inerte e oculto para acessibilidade ao iniciar a saída', () => {
    ...
    const event = { animationName: 'motion-fade-out', currentTarget: overlay } as unknown as AnimationEvent;
  ...
  it('mantém o overlay interativo durante a entrada', () => {
    const overlay = document.createElement('div');
    const event = { animationName: 'motion-fade-in', currentTarget: overlay } as unknown as AnimationEvent;
  ...
  it('torna o menu inerte quando sua animação de saída começa', () => {
    ...
    const event = { animationName: 'motion-menu-out', currentTarget: menu } as unknown as AnimationEvent;
