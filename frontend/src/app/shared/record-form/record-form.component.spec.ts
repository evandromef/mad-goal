...
describe('RecordFormComponent', () => {
  ...
  const record: LedgerItem = { id: 'r1', walletId: 'w1', assetId: 'a1', ticker: 'PETR4',
    type: 'COMPRA', date: '2026-08-01', quantity: 1, totalValue: 30 };
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({ imports: [RecordFormComponent], providers: [
  ...
  it('cadastra compra pesquisando o ativo e emite o registro salvo', () => {
    ...
    const emitted = vi.fn(); component.saved.subscribe(emitted);
    component.onPurchaseAssetInput('petr4');
    component.form.patchValue({ quantity: 2, totalValue: 61, unitPrice: 30, fees: 1 });
    component.save();

    expect(api.createRecord).toHaveBeenCalledWith(expect.objectContaining({
      walletId: 'w1', assetId: 'a1', type: 'COMPRA', quantity: 2, totalValue: 61, unitPrice: 30, fees: 1
    }));
  ...
  it('restringe tipos, lista somente ativos da carteira e trata erro', () => {
    ...
    component.form.controls.type.setValue('JCP'); component.onTypeChange();
  ...
  it('configura bonificação e evento corporativo com os campos corretos', () => {
    ...
    fixture.detectChanges();
    const component = fixture.componentInstance;
    component.form.patchValue({ type: 'BONIFICACAO', assetId: 'a1', quantity: 3 }); component.onTypeChange();
